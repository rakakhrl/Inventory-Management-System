...
public class AddCustomerForm extends javax.swing.JFrame {
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        String namaSupplier = namaCustomerTextField.getText();
        String alamat = alamatTextField.getText();

        HashMap<String, String> response = _customerCtrl.addCustomer(kodeCustomer, kodeCustomer, alamat);
